    ...
    <main className="min-h-screen bg-[#f7f9fc] text-[#0b1220]">
      <header className="sticky top-0 z-20 border-b border-[#e4e9f0] bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-4 lg:px-8">
          <Link href="/jobs" className="flex items-center gap-2.5"><span className="grid size-9 place-items-center rounded-xl bg-[#155eef] text-sm font-black text-white">R</span><span className="text-lg font-extrabold tracking-tight">RemoteScout</span></Link>
          <Link href="/jobs" className="rounded-full border border-[#d8e0ea] bg-white px-4 py-2.5 text-sm font-semibold hover:border-[#155eef] hover:text-[#155eef]">Back to jobs</Link>
        </div>
      </header>
        ...
        <section className="mt-5 rounded-[2rem] border border-[#dbe6f7] bg-gradient-to-br from-[#eef4ff] via-white to-white p-7 shadow-sm sm:p-10">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
            ...
            <div className="flex shrink-0 flex-wrap gap-2">
              ...
              <a href={typedJob.application_url} target="_blank" rel="noreferrer" className="rounded-full bg-[#155eef] px-6 py-3 text-center text-sm font-bold text-white shadow-lg shadow-[#155eef]/20 hover:bg-[#0b4dcc]">Apply for this job</a>
            </div>
          </div>
        </section>
